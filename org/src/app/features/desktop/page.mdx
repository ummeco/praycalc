export const metadata = {
  title: 'Desktop App',
  description:
    'PrayCalc for macOS, Windows, and Linux. Prayer times in your menu bar or system tray with notifications, Qibla direction, and Hijri date.',
}

export const sections = [
  { title: 'Overview', id: 'overview' },
  { title: 'Download', id: 'download' },
  { title: 'macOS', id: 'macos' },
...
PrayCalc runs natively on macOS, Windows, and Linux. Prayer times in your menu bar or system tray, adhan notifications, Qibla direction, and Hijri calendar without opening a browser. {{ className: 'lead' }}
