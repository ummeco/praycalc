export const metadata = {
  ...
  description:
    'PrayCalc for Apple TV, Android TV, and Fire TV. Full-screen prayer clock, masjid signage, ambient screensaver, and iqamah management for your living room or masjid.',
}

export const sections = [
  { title: 'Overview', id: 'overview' },
  { title: 'Apple TV', id: 'apple-tv' },
  { title: 'Android TV & Fire TV', id: 'android-tv' },
...
PrayCalc has dedicated TV apps for Apple TV, Android TV, and Fire TV. Display prayer times on your living room screen or use it as a full-screen masjid sign with iqamah times and announcements. {{ className: 'lead' }}
...
## Android TV & Fire TV {{ id: 'android-tv' }}
