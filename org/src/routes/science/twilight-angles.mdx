...
description: 'What happens optically when the Sun is below the horizon and why Islamic Fajr and Isha are defined by twilight depression angles.'
---
...
¹ **Tehran** — included for completeness as a widely-referenced value. This method originates from the Institute of Geophysics, University of Tehran and is used primarily by Shia Muslim communities. It is not within the ahl us-sunnah wal-jamaah scholarly tradition.
