      ...
      <div className="flex items-center gap-5">
        <nav className="hidden md:block">
          <ul role="list" className="flex items-center gap-8">
            <TopLevelNavItem href="#science">Science</TopLevelNavItem>
            <TopLevelNavItem href="#packages">Packages</TopLevelNavItem>
            <TopLevelNavItem href="https://github.com/acamarata">GitHub</TopLevelNavItem>
          </ul>
        </nav>
