// FILE: src/components/islands/search/icons.tsx
// PURPOSE: Small inline SVG icons for the docs search dialog (search glass,
//   no-results, loading spinner). Split out of Search.tsx to keep that file
...
export function NoResultsIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" {...props}>
...
export function LoadingIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  const id = useId();
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" {...props}>
