...
description: 'The 14 standard Islamic prayer time calculation methods — Fajr and Isha depression angles, organization, and region of use.'
---
...
- ¹ **Tehran** — included here for completeness as a widely-cited reference method. It originates from the Institute of Geophysics, University of Tehran and is primarily used by Shia Muslim communities in Iran. It is not within the ahl us-sunnah wal-jamaah scholarly tradition. PrayCalc does not recommend or implement this method.
