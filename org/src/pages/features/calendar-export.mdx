...
description: 'Download prayer time calendars as PDF — monthly, full-year, or Ramadan format with Hijri dates, Suhoor, and Iftar times.'
---
...
| `tz` | string | Yes | IANA timezone name (e.g., `America/New_York`) or numeric UTC offset (`-14`..`14`) |
