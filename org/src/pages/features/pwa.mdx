...
description: 'PrayCalc is a Progressive Web App — install it to your home screen for offline prayer times, adhan reminders, and native-like experience on any device.'
---
...
The service worker is registered automatically by the Serwist build integration. It lives at `/sw.js` and handles:
