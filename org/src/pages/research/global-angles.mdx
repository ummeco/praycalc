...
description: 'DPC-computed Fajr and Isha depression angles for 12 cities across 5 continents, broken down by month. All values computed from the pray-calc getAngles() function.'
---
