    ...
    <main className="min-h-screen bg-[#0D2F17]">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-white/70 leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">1. Acceptance</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">2. Service Description</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">3. Account Requirements</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">4. Islamic Content Guidelines</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">5. Prohibited Use</h2>
            <ul className="list-disc space-y-1 pl-6">
          ...
          <section>
            ...
            <p>
              Ummat+ subscriptions are processed by <strong className="text-white/90">Stripe Inc.</strong> Subscriptions auto-renew unless cancelled before the renewal date. Refund policy: <a href="https://ummat.pro/refund" className="text-[#79C24C] underline">ummat.pro/refund</a> (14-day window for digital goods).
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">7. Disclaimers</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">8. Termination</h2>
            <p>
              We may suspend or terminate your account for Terms violations. You may delete your account at any time via Settings. Upon deletion, your data is removed per our <Link href="/privacy" className="text-[#79C24C] underline">Privacy Policy</Link>.
            </p>
          </section>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">10. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#79C24C]">11. Changes to Terms</h2>
            <p>
          ...
          <section>
            ...
            <p>
              Legal: <a href="mailto:legal@ummat.dev" className="text-[#79C24C] underline">legal@ummat.dev</a><br />
              Abuse: <a href="mailto:abuse@ummat.dev" className="text-[#79C24C] underline">abuse@ummat.dev</a><br />
              <br />
