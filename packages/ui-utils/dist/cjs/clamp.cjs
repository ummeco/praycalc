...
exports.clamp = clamp;
exports.clampRotateMinutes = clampRotateMinutes;
exports.clampMinutes1to60 = clampMinutes1to60;
 ...
 */
function clampRotateMinutes(value) {
 ...
 */
function clampMinutes1to60(value, fallback) {
    if (!Number.isFinite(value))
        return fallback;
