 ...
 */
export function mapMethodToIos(method) {
...
export function mapMadhabToIos(madhab) {
...
export function toIosWatchContext(payload) {
    return {
...
export function toWearPrayerTimes(payload) {
    return {
