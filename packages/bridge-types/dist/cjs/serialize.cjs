...
exports.mapMethodToIos = mapMethodToIos;
exports.mapMadhabToIos = mapMadhabToIos;
exports.formatHHmm = formatHHmm;
exports.toIosWatchContext = toIosWatchContext;
exports.toWearPrayerTimes = toWearPrayerTimes;
 ...
 */
function mapMethodToIos(method) {
    return METHOD_TO_IOS[method] ?? method.toLowerCase();
}
...
function mapMadhabToIos(madhab) {
    return MADHAB_TO_IOS[madhab] ?? madhab.toLowerCase();
}
...
function toIosWatchContext(payload) {
    return {
...
function toWearPrayerTimes(payload) {
    return {
