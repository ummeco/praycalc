...
exports.isValidIosWatchContext = isValidIosWatchContext;
exports.isValidWearPrayerTimesPayload = isValidWearPrayerTimesPayload;
 ...
 */
function isValidIosWatchContext(value) {
...
function isValidWearPrayerTimesPayload(value) {
