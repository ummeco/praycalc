 ...
 * from a Julian Date.
 */
export function solarEphemeris(jd) {
 ...
 */
export function solarVerticalSpeed(latRad, declRad, hAngleRad) {
    return (15 *
 ...
 */
export function atmosphericRefraction(altitudeDeg, pressureMbar = 1013.25, temperatureC = 15) {
    if (altitudeDeg < -1)
        return 0;
    const DEG = Math.PI / 180;
