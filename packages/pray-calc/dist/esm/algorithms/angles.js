...
import { toJulianDate, solarEphemeris, atmosphericRefraction } from "./solar-ephemeris.js";
import { getMscFajr, getMscIsha, minutesToDepression } from "./msc.js";
const K_FAJR_MIN = 10;
const K_FAJR_MAX = 22;
const K_ISHA_MIN = 10;
const K_ISHA_MAX = 22;
 ...
 */
export function getAngles(date, lat, _lng, { elevation = 0, temperature = 15, pressure = 1013.25, shafaq = ShafaqMode.general, } = {}) {
    ...
    const mscIshaMin = getMscIsha(date, lat, shafaq);
    // 3. Convert MCW minutes to equivalent solar depression angles.
    let fajrBase = minutesToDepression(mscFajrMin, lat, eph.decl);
    let ishaBase = minutesToDepression(mscIshaMin, lat, eph.decl);
