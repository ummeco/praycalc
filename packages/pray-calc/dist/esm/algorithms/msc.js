 ...
 */
export function getMscFajr(date, latitude) {
 ...
 */
export function getMscIsha(date, latitude, shafaq = ShafaqMode.general) {
    const latAbs = Math.abs(latitude);
    const { dyy, daysInYear } = computeDyy(date, latitude);
    let a, b, c, d;
    switch (shafaq) {
 ...
 */
export function minutesToDepression(minutes, latDeg, declDeg) {
